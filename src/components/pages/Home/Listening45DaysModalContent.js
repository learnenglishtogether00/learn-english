...
const Listening45DaysModalContent = (props) => {
  ...
  return (
    <Fragment>
      ...
      >
            ...
            <Card elevation={0} className={classes.cardWrap}>
              <CardContent>
                ...
                <Typography variant="subtitle1">
                  Đọc hướng dẫn trước khi test.
                </Typography>
                <Link to={`/listening-45-days-document?test=${testDetail.id}`}>
        ...
        <Grid item xs={testDetail.introURL ? 6 : 12}>
          <Card elevation={0} className={classes.cardWrap}>
            <CardContent>
              ...
              <Link to={`/listening-45-days-listen?test=${testDetail.id}`}>
                <Typography variant="button" className={classes.actionButton}>
                  Let Go
                </Typography>
              </Link>
...
export default Listening45DaysModalContent;
